...
#Nested Vocabularies
mean.vocabularies.build(word: "abase", description: "to humiliate, degrade", trigger: "fall into abyss")
indifferent.vocabularies.build(word: "apathetic", description: "lacking concern, emotion", trigger: "no empathy")
smart.vocabularies.build(word: 'cogent', description: "intellectually convincing", trigger: "the FBI agent was coherent")
mean.vocabularies.build(word: 'demean', description: 'to lower the status or stature of something', trigger: 'mean stunts to humiliate')
